        ...
        <div className="flex w-screen text-center items-center justify-center">
            ...
            <div className="py-12 px-12 bg-white rounded-2xl shadow-xl z-20">
                ...
                <div className="text-center">
                    <h1 className="text-3xl font-semibold text-center mb-4 cursor-pointer">Создайте аккаунт</h1>
                    <div className="text-center text-sm mb-8 font-semibold text-gray-700">Создайте аккаунт, чтобы пользоваться нашим сервисом</div>
                </div>
                ...
                <div className="text-center mt-6 mt-12">
                    ...
                    <p className="mt-4 text-sm">Уже есть аккаунт? <span className="underline cursor-pointer">Войти</span>
                    </p>
                </div>
            </div>
